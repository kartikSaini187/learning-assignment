      ...
      <div class="row">
        ...
        <div class="col-md-8 mb-4">
          ...
          <div class="card">
            ...
            <!--Card content-->
            <form class="card-body" method="POST" action="orderplace.php" >
              ...
              <hr class="mb-4">
              <button class="btn btn-primary btn-lg btn-block" type="submit" name="orderplace" >Placeyour order</button>
...
try {
   ...
   $total += $v['totalprice'];
        ...
        <div>
          <h6 class="my-0">'.$v['productname'].'</h6>
          <small class="text-muted">Brief description</small>
        </div>
        <span class="text-muted">Rs'.$v['price'].'</span>
      </li>';
    }
