...
if(isset($_POST['addproduct'])){
    ...
    $pcat = $_POST['newpcat'];
    $pprice =  $_POST['newpprice'];
    $pimage = $_POST['newpimage'];
    $pdetails = $_POST['newpdetail'];
  
  try {
   $conn = new PDO("mysql:host=$servername;dbname=$cartdb", $username, $password);
   $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
   
   $sql = " INSERT INTO tb_product (productId, productName, productCategory, productPrice, productImage, moredetails) VALUES (null, '$pname','$pcat','$pprice','$pimage','$pdetails')";
